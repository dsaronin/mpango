module Mpango
  module Gateways
    class Base #:nodoc:
      ...
      # recurring billing.
      #
      # should return a Mpango::Response
      ...
      ##
      ## Only needed to support Mpango.billing_controller = :arb
      ##
      ...
      #
      # return value should be a collection of Mpango::Transaction objects.
      def transactions(options = {})
        raise MethodNotImplemented
      end

      ##
      ## Only needed to support Mpango.billing_controller = :mpango
      ##

      # charges money against the given billing key.
      # should return a Mpango::Transaction
