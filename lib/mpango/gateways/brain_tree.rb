...
module Mpango
  module Gateways
    ...
    # In your config/initializers/mpango.rb, configure Mpango to use BrainTree:
    #
    #   Mpango.gateway = Mpango::Gateways::BrainTree.new
    #   Mpango.gateway.username = "my_username"
    #   Mpango.gateway.password = "my_password"
    #
    ...
    # All credit cards should use Mpango::CreditCard class (currently just an alias for ActiveMerchant::Billing::CreditCard).
    # All addresses should use Mpango::Address class.
    #
    # = For Testing
    ...
    class BrainTree
      ...
      def charge(vault_id, amount)
        ...
        p.commit
        return Mpango::Transaction.new(:billing_key => vault_id, :amount => amount, :success => p.response.success?)
      end
      ...
      class Post
        ...
        def commit
          ...
          @response = Mpango::Response.new(success, data)
