  ...
  module ManualBilling
    ...
    def charge!
      self.class.transaction do
        ...
        transaction = Mpango.gateway.charge(billing_key, subscription_plan.rate)
        Mpango.activity_log[self] << transaction if Mpango.log?
    ...
    module ClassMethods
      ...
      def run_billing
        Mpango.with_activity_logging do
          ...
          Mpango.mailer.deliver_admin_report(
            Mpango.admin_report_recipients,
            Mpango.activity_log
          ) if Mpango.admin_report_recipients
        end
      end
